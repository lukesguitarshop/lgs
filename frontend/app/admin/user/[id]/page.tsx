    ...
    <div className="max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          {!editing ? (
            <Button onClick={() => setEditing(true)} className="bg-[#df5e15] hover:bg-[#c54d0a] text-white">
            ...
            <>
              ...
              <Button onClick={handleSave} className="bg-[#df5e15] hover:bg-[#c54d0a] text-white" disabled={saving}>
            ...
            <div>
              ...
              {editing ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-gray-900">{user.email || <span className="italic text-gray-500">No email</span>}</p>
                </div>
              )}
            </div>
