...
function AboutContent() {
  return (
    <div className="max-w-3xl mx-auto">
      <h2 className="text-3xl font-bold mb-6">About Luke's Guitar Shop</h2>
      ...
      <div className="prose prose-lg dark:prose-invert">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Our Story</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Where to Find Us</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Easy, Secure Checkout</h3>
        <p className="text-muted-foreground mb-6">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Our Promise</h3>
        <p className="text-muted-foreground mb-6">
      ...
      <div className="max-w-xl mx-auto text-center">
        <div className="bg-green-100 dark:bg-green-900/30 border border-green-500 rounded-lg p-8">
          ...
          <button
            ...
            className="px-6 py-2 rounded-lg bg-[#df5e15] text-white hover:bg-[#c74d12] transition-colors font-medium cursor-pointer"
          >
    ...
    <div className="max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full px-6 py-3 rounded-lg bg-[#df5e15] text-white hover:bg-[#c74d12] transition-colors font-medium cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      <p className="text-muted-foreground text-sm mt-6 text-center">
        ...
        <a
          ...
          className="text-[#df5e15] hover:text-[#c74d12] underline cursor-pointer"
        >
...
export default function ShopInfoPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8">Shop Info</h1>
